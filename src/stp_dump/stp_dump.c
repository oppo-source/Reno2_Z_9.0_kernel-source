...
#define COMBO_T32_DIR         OPPO_STP_DUMP_DCS_PATH
#endif /* VENDOR_EDIT */
    ...
    if ((stpmsghdr[0] == '[') &&
        ...
        if (start_dump) {
            ...
            if (atoi(coredump_mode) == 2) {
                ...
                #ifdef VENDOR_EDIT
                //Guotian.Wu@PSW.CN.WiFi.Basic.Log.1162004, 2018/09/04
                //Add for: collect kernel log dump
                collect_kernel_log(date);
                #endif /* VENDOR_EDIT */
            }
