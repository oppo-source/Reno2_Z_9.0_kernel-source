...
#ifndef VENDOR_EDIT
//Botao.Cu@PSW.CN.WiFi.Connect.associated.1062687, 2016/12/29,
//modify for filter invalid eap packet.
...
#define IS_VALID_EAP_PACKET(code) ((code < EAP_CODE_REQUEST) || \
				   (code >= EAP_CODE_MAX) ? 0 : 1)
#endif /* VENDOR_EDIT */
