...
static int wpa_cli_cmd_get_vendor_spec(struct wpa_ctrl *ctrl, int argc,
				     char *argv[])
{
	return wpa_ctrl_command(ctrl, "GET_VENDOR_SPEC");
}
#endif /* VENDOR_EDIT */
...
static const struct wpa_cli_cmd wpa_cli_commands[] = {
	...
	//Yuan.Huang@PSW.CN.WiFi.Network.internet.1140781, 2017/10/30,
	//Add for get_vendor_spec
	{ "get_vendor_spec", wpa_cli_cmd_get_vendor_spec, NULL,
	  cli_cmd_flag_none,
	  "= get vendor specific of current bss" },
	#endif /* VENDOR_EDIT */
