...
#ifdef VENDOR_EDIT
//Chuanye.Xu@PSW.CN.WiFi.Connect.auth.1058482, 2016/07/09,
//add for [FC1]:alert wrong key or auth timeout.
#include <vendor/oppo/hardware/wifi/supplicant/1.0/IOppoSupplicantStaIface.h>
#include <vendor/oppo/hardware/wifi/supplicant/1.0/IOppoSupplicantStaIfaceCallback.h>
#endif /* VENDOR_EDIT */
...
using vendor::oppo::hardware::wifi::supplicant::V1_0::IOppoSupplicantStaIfaceCallback;
#endif /* VENDOR_EDIT */
...
//Modify for oppo wifi reconnect
/*
class StaIface : public ISupplicantStaIface
*/
#else /* VENDOR_EDIT */
class StaIface
    : public vendor::oppo::hardware::wifi::supplicant::V1_0::IOppoSupplicantStaIface
#endif /* VENDOR_EDIT */
{
public:
	...
	Return<void> manuReassociate(manuReassociate_cb _hidl_cb) override;
#endif /* VENDOR_EDIT */
#ifdef VENDOR_EDIT
	//Yuan.Huang@PSW.CN.WiFi.Network.1140781, 2017/10/30,
	//Add for data stall detection:get AP vendor info
	Return<void> doStringCommand(
	    const hidl_string &cmd,
	    doStringCommand_cb _hidl_cb) override;
#endif /* VENDOR_EDIT */
	...
	Return<void> setOshareMod(
	        IOppoSupplicantStaIface::OshareMode mode,
			setOshareMod_cb _hidl_cb) override;
#endif /* VENDOR_EDIT */
...
private:
	...
	//Chuanye.Xu@PSW.CN.Wifi.Connect.AutoConnect.872537, 2017/11/11,
	//Add for oppo wifi reconnect
	SupplicantStatus manuReassociateInternal();
#endif /* VENDOR_EDIT */
#ifdef VENDOR_EDIT
    //Yuan.Huang@PSW.CN.WiFi.Network.1140781, 2017/10/30,
    //Add for data stall detection:get AP vendor info
    std::pair<SupplicantStatus, std::string> doStringCommandInternal(
    ...
    //Tao.Hui@PSW.CN.WiFi.Basic.P2P.1069764, 2017/11/02,
    //Add for Hidl interface for mtk Oshare Mode.
    SupplicantStatus setOshareModInternal(IOppoSupplicantStaIface::OshareMode mode);
#endif /* VENDOR_EDIT */
