...
//Chuanye.Xu@PSW.CN.WiFi.Connect.auth.1058482, 2017/10/25,
//add for [FC1]:alert wrong key or auth timeout.
static void wpas_hidl_notify_select_network(struct wpa_supplicant *wpa_s) {}
static void wpas_hidl_notify_ssid_temp_disabled(struct wpa_supplicant * wpa_s, int netid, char *reason) {}
#endif /* VENDOR_EDIT */
