...
public final class IoBridge {
    ...
    public static FileDescriptor open(String path, int flags) throws FileNotFoundException {
        ...
        try {
            ...
            //#ifndef VENDOR_EDIT
            //Jiemin.Zhu@PSW.Android.Stability.Crash, 2018.01.25, Add for debug and retry for O_CREAT mode
            //FileNotFoundException ex = new FileNotFoundException(path + ": " + errnoException.getMessage());
            //#else
            int mode = ((flags & O_ACCMODE) == O_RDONLY) ? 0 : 0600;
            FileNotFoundException ex = new FileNotFoundException("flags: " + flags + " mode: " + mode + " " + path + ": " + errnoException.getMessage());
            //#endif /* VENDOR_EDIT */
