...
//#ifdef VENDOR_EDIT
//Kui.Jiang@PSW.AD.Stability.Compatibility.1255453, 2017/02/21, Modify for bug 1186528.
        ...
        if (ss == null) {
            ...
            */
            ...
            if (!VMRuntime.getRuntime().getDisableCompatbilityFlag() &&
                    separator.equals(this.path) &&
                    VMRuntime.getRuntime().getTargetSdkVersion() <= 23) {
                java.lang.System.logE("Can not read rootfs anymore, return a fake result!", new Throwable());
