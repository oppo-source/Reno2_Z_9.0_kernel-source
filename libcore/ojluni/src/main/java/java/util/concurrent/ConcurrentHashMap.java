...
//#indef VENDOR_EDIT
//#Qianyou.Chen@PSW.AD.Stability.Compatibility.1069848, 2018/03/07, Add for control the compatibility modification.
...
public class ConcurrentHashMap<K,V> extends AbstractMap<K,V>
    ...
    public boolean containsKey(Object key) {
        //#ifndef VENDOR_EDIT
        //Fangfang.Hui@PSW.AD.Stability.Compatibility.1160512, 2015/08/26, Modify for method get()  may be rewrite by third part APK
        /*
            return get(key) != null;
        */
        //#else /*VENDOR_EDIT*/
        //#Qianyou.Chen@PSW.AD.Stability.Compatibility.1069848, 2018/03/07, Modify for control the compatibility modification.
        if (!VMRuntime.getRuntime().getDisableCompatbilityFlag()) {
            ...
            if ((tab = table) != null && (n = tab.length) > 0 &&
                ...
                if ((eh = e.hash) == h) {
                    ...
                    return (p = e.find(h, key)) != null ? true : false;
                while ((e = e.next) != null) {
                    if (e.hash == h &&
                        ((ek = e.key) == key || (ek != null && key.equals(ek))))
                        return true;
