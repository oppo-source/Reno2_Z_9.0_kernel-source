...
public final class VMRuntime {
    ...
    public synchronized boolean getDisableCompatbilityFlag() {
        return disableCompatibilityFlag;
    }

    private native void setDisableCompatibilityFlagNative(boolean disableCptFlag);
    //#endif VENDOR_EDIT
    ...
    //#ifdef VENDOR_EDIT
    //Zongjun.Li@PSW.AD.Stability.Compatibility.1136800, 2017/03/28, Add for baiduprotection
    public static native void setVMRuntimeFlag(int vmRuntimeFlag);
    //#endif /* VENDOR_EDIT */
}
